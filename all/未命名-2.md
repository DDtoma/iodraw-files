...
classDiagram
    ...
    class Session {
        ...
        +addHistoryEntry(agentInstanceId: string, entry: ExecutionHistory): void
        +getAgentHistory(agentInstanceId: string): ExecutionHistory[]
        +hasHistoryFor(agentInstanceId: string): boolean
