...
classDiagram
    ...
    class AgentRunner {
        ...
        +getExecutor(sessionId: string): AgentExecutor
        +executeAgent(sessionId: string, input: any): Promise~ExecutionResult~
        +registerAgentClass(name: string, agentClass: typeof BaseAgent): boolean
        +createExecutor(sessionId: string, agentType: string, config: AgentConfig): string
