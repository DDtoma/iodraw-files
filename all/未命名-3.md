...
graph TB
    ...
    %% 元认知系统与定向阶段的交互 - 不再与决策阶段交互
    StrategyAdjuster -->|"策略建议"| Orient
    GoalMaintainer -->|"目标维护信息"| Orient
    Orient -->|"情境信息"| SelfMonitor
    ...
    %% 删除元认知系统与决策阶段的交互
    %% StrategyAdjuster -->|"策略建议"| Decide
    %% Decide -->|"决策反馈"| SelfMonitor
    %% GoalMaintainer -->|"目标维护信息"| Decide
