...
classDiagram
    ...
    class Orchestrator {
        -activeModules: Map~string, IModule~
        -taskQueue: PriorityQueue~Task~
        -resourcePool: ResourcePool
        +registerModule(id: string, module: IModule): boolean
        +unregisterModule(id: string): boolean
        +callModule(id: string, operation: string, params: any): Promise~Result~
        +callModuleSync(id: string, operation: string, params: any): Result
