...
graph TB
    ...
    %% 系统间主要数据流
    WorkingMemory -->|"上下文记忆"| ContextInjector
    MemoryManager -->|"检索记忆"| ContextInjector
    KnowledgeRetrieval -->|"相关知识"| ContextInjector
    SelfMonitor -->|"元认知信息"| ContextInjector
    
    Orient -->|"信息装配请求"| PromptAssembler
    ContextInjector -->|"富集上下文"| PromptAssembler
    PromptAssembler -->|"装配完成提示词"| Orient
